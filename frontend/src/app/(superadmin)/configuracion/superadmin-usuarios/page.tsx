...
import {
  ShieldCheck, Plus, Loader2, Key, Trash2, UserCheck, UserX, RefreshCw, Pencil,
} from "lucide-react";
                        ...
                        {!isSelf && (
                          <>
                            <Button
                              ...
                              className="h-8 w-8 p-0 text-gray-400 hover:text-klyp-accent"
                            ...
                            >
                              {u.is_active
                                ? <UserX className="h-3.5 w-3.5 text-orange-400 hover:text-orange-600" />
